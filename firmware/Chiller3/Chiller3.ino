...
static const char* SUPABASE_RPC_URL =
  "https://eeobivvwjzakbweluwtm.supabase.co/rest/v1/rpc/ingest_ch3";
...
static const char* DEVICE_CODE   = "ESP32-CH3-PLC";
...
void setup() {
  ...
  Serial.println();
  Serial.println("======================================================");
  Serial.println("WT32-ETH01 CHILLER 3 - MINIMAL TELEMETRY + RECOVERY");
